...
public class FileUploadController {
    ...
    // String ip = "http://192.168.25.220"; 硬编码
    // http://192.168.25.220 服务器的Ip地址作为一个配置文件放入项目中！软编码！
    // 获取上传文件，需要使用springmvc 技术
    @RequestMapping("fileUpload")
    public String fileUpload(MultipartFile file)throws IOException, MyException {

        String imgUrl = fileUrl; // imgUrl=http://192.168.25.220
        // 当文件不为空的时候，进行上传！
        if (file!=null){
            ...
            for (int i = 0; i < upload_file.length; i++) {
                 ...
                 */
//                imgUrl=http://192.168.25.220/group1/M00/00/00/wKhD2106tuSAY9S9AACGx2c4tJ4084.jpg
                imgUrl+="/"+path;
            }
        }

       //  return "http://192.168.25.220/group1/M00/00/00/wKhD2106tuSAY9S9AACGx2c4tJ4084.jpg";
        return imgUrl;
    }
